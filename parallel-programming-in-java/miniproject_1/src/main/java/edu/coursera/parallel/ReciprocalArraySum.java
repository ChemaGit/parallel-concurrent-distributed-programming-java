...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
         ...
         * @param nChunks number of chunks or tasks
         */
        ...
        protected void compute() {
            // TODO
            if (isJobLittleEnough()) {
                sumUp();
            } else {
                Collection<ReciprocalArraySumTask> all = ForkJoinTask.invokeAll(createJobs());
        ...
        private List<ReciprocalArraySumTask> createJobs() {
            List<ReciprocalArraySumTask> tasks = new ArrayList<>(numChunks);
            for (int i = 0; i < numChunks; i++) {
                ReciprocalArraySumTask task = new ReciprocalArraySumTask(
                        getChunkStartInclusive(i, numChunks, input.length),
                        getChunkEndExclusive(i, numChunks, input.length),
                        input,
                        0);
                tasks.add(task);
            }
